...
public class Triangle implements Shape {
	...
	Triangle(String temp1, String temp2, String temp3) throws TriangleException {
	...
	public String toString() {
		return String.format("Triangle\t{s1=%5.2f, s2=%5.2f, s3=%5.2f}\t perimeter = %6.2f", this.getS1(), this.getS2(),
				this.getS3(), this.perimeter());
	}
